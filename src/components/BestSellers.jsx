        ...
        {products.map((product, index) => (
          ...
          >
            <div className="relative">
              ...
              />
              <button
                className="absolute right-2 top-2 grid h-8 w-8 place-items-center rounded-full bg-white/80 text-cocoa shadow-sm backdrop-blur transition hover:bg-tissue sm:right-4 sm:top-4 sm:h-11 sm:w-11"
            ...
            <div className="px-3 pb-4 pt-3 text-center">
              ...
              <p className="mt-1 text-base font-bold text-ink sm:mt-3 sm:text-lg">{product.price}</p>
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`Hi Suvarna Veni, I want to order ${product.name}`)}`}
